...
public class AccountController {
    ...
    public ResponseEntity<AccountDTO> createAccount(@RequestHeader("Authorization") String authorizationHeader, @RequestBody AccountDTO accountDTO) throws MessagingException {
    ...
    public ResponseEntity<Map<String, Object>> getUserAccountBalance(@RequestHeader(value = "Authorization") String authorizationHeader, @PathVariable(name = "accountNumber") String accountNumber) throws UserNotFoundException {
        String email = jwtUtils.getEmailFromHeader(authorizationHeader);
        Map<String, Object> response = new HashMap<>();
        response.put("accountNumber", accountNumber);
        response.put("balance", accountService.getUserAccountBalance(accountNumber, email));
        return new ResponseEntity<>(
                response,
                HttpStatus.OK
        );
